...
namespace commands
{
    public static class Universal
    {
        ...
        public static void createLayer(string layerName, Transaction trans)
        {
            ...
            {
                newLayer.Color = Teigha.Colors.Color.FromColorIndex(Teigha.Colors.ColorMethod.ByLayer, 4);
            }
            else
            {
                newLayer.Color = Teigha.Colors.Color.FromColorIndex(Teigha.Colors.ColorMethod.ByLayer, 6);
            }
