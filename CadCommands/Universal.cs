    ...
    public static class Universal
    {
        ...
        public static void getBlockFromMaster(string blockName, Transaction trans)
        {
            try
            {
                ...
                PROG.DatabaseServices.TransactionManager otherTransManager = sourceDb.TransactionManager;
                using (Transaction otherTrans = otherTransManager.StartTransaction())
                {
                    BlockTable bt = (BlockTable)otherTransManager.GetObject(sourceDb.BlockTableId, OpenMode.ForRead, false);

                    foreach (ObjectId btrId in bt)
                    {
                        BlockTableRecord btr = (BlockTableRecord)otherTransManager.GetObject(btrId, OpenMode.ForRead, false);
